 ...
 * <ul>
 *   <li>{@link mowl.impl.DataSomeValuesFromImpl#getDataProperties <em>Data Properties</em>}</li>
 *   <li>{@link mowl.impl.DataSomeValuesFromImpl#getLiterals <em>Literals</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataSomeValuesFromImpl extends ClassExpressionImpl implements DataSomeValuesFrom {
	...
	protected EClass eStaticClass() {
		return mowlPackage.Literals.DATA_SOME_VALUES_FROM;
	}
		...
		if (dataProperties != null && dataProperties.eIsProxy()) {
			...
			if (dataProperties != oldDataProperties) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, mowlPackage.DATA_SOME_VALUES_FROM__DATA_PROPERTIES, oldDataProperties, dataProperties));
			}
		}
	...
	public void setDataProperties(DataProperty newDataProperties) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, mowlPackage.DATA_SOME_VALUES_FROM__DATA_PROPERTIES, oldDataProperties, dataProperties));
	}
	...
	public EList<Constant> getLiterals() {
		if (literals == null) {
			literals = new EObjectResolvingEList<Constant>(Constant.class, this, mowlPackage.DATA_SOME_VALUES_FROM__LITERALS);
		}
		return literals;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case mowlPackage.DATA_SOME_VALUES_FROM__DATA_PROPERTIES:
				if (resolve) return getDataProperties();
				return basicGetDataProperties();
			case mowlPackage.DATA_SOME_VALUES_FROM__LITERALS:
				return getLiterals();
		}
