...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Link Max Cardinality</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link mowl.impl.LinkMaxCardinalityImpl#getClasses <em>Classes</em>}</li>
 *   <li>{@link mowl.impl.LinkMaxCardinalityImpl#getLinkProperties <em>Link Properties</em>}</li>
 *   <li>{@link mowl.impl.LinkMaxCardinalityImpl#getCardinality <em>Cardinality</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class LinkMaxCardinalityImpl extends EConnectionExpressionImpl implements LinkMaxCardinality {
	/**
	 ...
	 * @generated
	 */
	protected LinkMaxCardinalityImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return mowlPackage.Literals.LINK_MAX_CARDINALITY;
	}
		...
		if (classes != null && classes.eIsProxy()) {
			...
			if (classes != oldClasses) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, mowlPackage.LINK_MAX_CARDINALITY__CLASSES, oldClasses, classes));
			}
		}
		return classes;
	}
	...
	public void setClasses(mowl.Class newClasses) {
		...
		classes = newClasses;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, mowlPackage.LINK_MAX_CARDINALITY__CLASSES, oldClasses, classes));
	}
	...
	public LinkProperty getLinkProperties() {
		if (linkProperties != null && linkProperties.eIsProxy()) {
			...
			if (linkProperties != oldLinkProperties) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, mowlPackage.LINK_MAX_CARDINALITY__LINK_PROPERTIES, oldLinkProperties, linkProperties));
			}
		}
	...
	public void setLinkProperties(LinkProperty newLinkProperties) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, mowlPackage.LINK_MAX_CARDINALITY__LINK_PROPERTIES, oldLinkProperties, linkProperties));
	}
	...
	public void setCardinality(int newCardinality) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, mowlPackage.LINK_MAX_CARDINALITY__CARDINALITY, oldCardinality, cardinality));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case mowlPackage.LINK_MAX_CARDINALITY__CLASSES:
				if (resolve) return getClasses();
				return basicGetClasses();
			case mowlPackage.LINK_MAX_CARDINALITY__LINK_PROPERTIES:
				if (resolve) return getLinkProperties();
				return basicGetLinkProperties();
			case mowlPackage.LINK_MAX_CARDINALITY__CARDINALITY:
