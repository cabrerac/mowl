...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Link Some Values From</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link mowl.impl.LinkSomeValuesFromImpl#getClasses <em>Classes</em>}</li>
 *   <li>{@link mowl.impl.LinkSomeValuesFromImpl#getLinkProperties <em>Link Properties</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class LinkSomeValuesFromImpl extends EConnectionExpressionImpl implements LinkSomeValuesFrom {
	/**
	 ...
	 * @generated
	 */
	protected LinkSomeValuesFromImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return mowlPackage.Literals.LINK_SOME_VALUES_FROM;
	}
		...
		if (classes != null && classes.eIsProxy()) {
			...
			if (classes != oldClasses) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, mowlPackage.LINK_SOME_VALUES_FROM__CLASSES, oldClasses, classes));
			}
		}
		return classes;
	}
	...
	public void setClasses(mowl.Class newClasses) {
		...
		classes = newClasses;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, mowlPackage.LINK_SOME_VALUES_FROM__CLASSES, oldClasses, classes));
	}
	...
	public LinkProperty getLinkProperties() {
		if (linkProperties != null && linkProperties.eIsProxy()) {
			...
			if (linkProperties != oldLinkProperties) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, mowlPackage.LINK_SOME_VALUES_FROM__LINK_PROPERTIES, oldLinkProperties, linkProperties));
			}
		}
	...
	public void setLinkProperties(LinkProperty newLinkProperties) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, mowlPackage.LINK_SOME_VALUES_FROM__LINK_PROPERTIES, oldLinkProperties, linkProperties));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case mowlPackage.LINK_SOME_VALUES_FROM__CLASSES:
				if (resolve) return getClasses();
				return basicGetClasses();
			case mowlPackage.LINK_SOME_VALUES_FROM__LINK_PROPERTIES:
