 ...
 * <ul>
 *   <li>{@link mowl.impl.ObjectSomeValuesFromImpl#getClasses <em>Classes</em>}</li>
 *   <li>{@link mowl.impl.ObjectSomeValuesFromImpl#getObjectProperties <em>Object Properties</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ObjectSomeValuesFromImpl extends ClassExpressionImpl implements ObjectSomeValuesFrom {
	...
	protected EClass eStaticClass() {
		return mowlPackage.Literals.OBJECT_SOME_VALUES_FROM;
	}
		...
		if (classes != null && classes.eIsProxy()) {
			...
			if (classes != oldClasses) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, mowlPackage.OBJECT_SOME_VALUES_FROM__CLASSES, oldClasses, classes));
			}
		}
		return classes;
	}
	...
	public void setClasses(mowl.Class newClasses) {
		...
		classes = newClasses;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, mowlPackage.OBJECT_SOME_VALUES_FROM__CLASSES, oldClasses, classes));
	}
	...
	public ObjectProperty getObjectProperties() {
		if (objectProperties != null && objectProperties.eIsProxy()) {
			...
			if (objectProperties != oldObjectProperties) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, mowlPackage.OBJECT_SOME_VALUES_FROM__OBJECT_PROPERTIES, oldObjectProperties, objectProperties));
			}
		}
	...
	public void setObjectProperties(ObjectProperty newObjectProperties) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, mowlPackage.OBJECT_SOME_VALUES_FROM__OBJECT_PROPERTIES, oldObjectProperties, objectProperties));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case mowlPackage.OBJECT_SOME_VALUES_FROM__CLASSES:
				if (resolve) return getClasses();
				return basicGetClasses();
			case mowlPackage.OBJECT_SOME_VALUES_FROM__OBJECT_PROPERTIES:
