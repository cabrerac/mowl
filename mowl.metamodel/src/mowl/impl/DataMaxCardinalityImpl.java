 ...
 * <ul>
 *   <li>{@link mowl.impl.DataMaxCardinalityImpl#getCardinality <em>Cardinality</em>}</li>
 *   <li>{@link mowl.impl.DataMaxCardinalityImpl#getDataProperties <em>Data Properties</em>}</li>
 *   <li>{@link mowl.impl.DataMaxCardinalityImpl#getLiterals <em>Literals</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataMaxCardinalityImpl extends ClassExpressionImpl implements DataMaxCardinality {
	...
	protected EClass eStaticClass() {
		return mowlPackage.Literals.DATA_MAX_CARDINALITY;
	}
	...
	public void setCardinality(int newCardinality) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, mowlPackage.DATA_MAX_CARDINALITY__CARDINALITY, oldCardinality, cardinality));
	}
	...
	public DataProperty getDataProperties() {
		if (dataProperties != null && dataProperties.eIsProxy()) {
			...
			if (dataProperties != oldDataProperties) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, mowlPackage.DATA_MAX_CARDINALITY__DATA_PROPERTIES, oldDataProperties, dataProperties));
			}
		}
	...
	public void setDataProperties(DataProperty newDataProperties) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, mowlPackage.DATA_MAX_CARDINALITY__DATA_PROPERTIES, oldDataProperties, dataProperties));
	}
	...
	public EList<Constant> getLiterals() {
		if (literals == null) {
			literals = new EObjectResolvingEList<Constant>(Constant.class, this, mowlPackage.DATA_MAX_CARDINALITY__LITERALS);
		}
		return literals;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case mowlPackage.DATA_MAX_CARDINALITY__DATA_PROPERTIES:
				if (resolve) return getDataProperties();
				return basicGetDataProperties();
			case mowlPackage.DATA_MAX_CARDINALITY__LITERALS:
				return getLiterals();
		}
