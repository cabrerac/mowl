 ...
 * <ul>
 *   <li>{@link mowl.impl.ObjectMaxCardinalityImpl#getCardinality <em>Cardinality</em>}</li>
 *   <li>{@link mowl.impl.ObjectMaxCardinalityImpl#getClasses <em>Classes</em>}</li>
 *   <li>{@link mowl.impl.ObjectMaxCardinalityImpl#getObjectProperties <em>Object Properties</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ObjectMaxCardinalityImpl extends ClassExpressionImpl implements ObjectMaxCardinality {
	...
	protected EClass eStaticClass() {
		return mowlPackage.Literals.OBJECT_MAX_CARDINALITY;
	}
	...
	public void setCardinality(int newCardinality) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, mowlPackage.OBJECT_MAX_CARDINALITY__CARDINALITY, oldCardinality, cardinality));
	}
	...
	public mowl.Class getClasses() {
		if (classes != null && classes.eIsProxy()) {
			...
			if (classes != oldClasses) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, mowlPackage.OBJECT_MAX_CARDINALITY__CLASSES, oldClasses, classes));
			}
		}
		return classes;
	}
	...
	public void setClasses(mowl.Class newClasses) {
		...
		classes = newClasses;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, mowlPackage.OBJECT_MAX_CARDINALITY__CLASSES, oldClasses, classes));
	}
	...
	public ObjectProperty getObjectProperties() {
		if (objectProperties != null && objectProperties.eIsProxy()) {
			...
			if (objectProperties != oldObjectProperties) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, mowlPackage.OBJECT_MAX_CARDINALITY__OBJECT_PROPERTIES, oldObjectProperties, objectProperties));
			}
		}
	...
	public void setObjectProperties(ObjectProperty newObjectProperties) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, mowlPackage.OBJECT_MAX_CARDINALITY__OBJECT_PROPERTIES, oldObjectProperties, objectProperties));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case mowlPackage.OBJECT_MAX_CARDINALITY__CLASSES:
				if (resolve) return getClasses();
				return basicGetClasses();
			case mowlPackage.OBJECT_MAX_CARDINALITY__OBJECT_PROPERTIES:
