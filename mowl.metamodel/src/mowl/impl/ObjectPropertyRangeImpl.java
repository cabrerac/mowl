 ...
 * <ul>
 *   <li>{@link mowl.impl.ObjectPropertyRangeImpl#getExpressions <em>Expressions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ObjectPropertyRangeImpl extends ObjectPropertyAxiomImpl implements ObjectPropertyRange {
	...
	protected EClass eStaticClass() {
		return mowlPackage.Literals.OBJECT_PROPERTY_RANGE;
	}
	...
	public EList<ClassExpression> getExpressions() {
		if (expressions == null) {
			expressions = new EObjectContainmentEList<ClassExpression>(ClassExpression.class, this, mowlPackage.OBJECT_PROPERTY_RANGE__EXPRESSIONS);
		}
		return expressions;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case mowlPackage.OBJECT_PROPERTY_RANGE__EXPRESSIONS:
