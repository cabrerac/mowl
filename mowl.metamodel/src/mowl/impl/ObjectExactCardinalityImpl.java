 ...
 * <ul>
 *   <li>{@link mowl.impl.ObjectExactCardinalityImpl#getCardinality <em>Cardinality</em>}</li>
 *   <li>{@link mowl.impl.ObjectExactCardinalityImpl#getClasses <em>Classes</em>}</li>
 *   <li>{@link mowl.impl.ObjectExactCardinalityImpl#getObjectProperties <em>Object Properties</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ObjectExactCardinalityImpl extends ClassExpressionImpl implements ObjectExactCardinality {
	...
	protected EClass eStaticClass() {
		return mowlPackage.Literals.OBJECT_EXACT_CARDINALITY;
	}
	...
	public void setCardinality(int newCardinality) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, mowlPackage.OBJECT_EXACT_CARDINALITY__CARDINALITY, oldCardinality, cardinality));
	}
	...
	public mowl.Class getClasses() {
		if (classes != null && classes.eIsProxy()) {
			...
			if (classes != oldClasses) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, mowlPackage.OBJECT_EXACT_CARDINALITY__CLASSES, oldClasses, classes));
			}
		}
		return classes;
	}
	...
	public void setClasses(mowl.Class newClasses) {
		...
		classes = newClasses;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, mowlPackage.OBJECT_EXACT_CARDINALITY__CLASSES, oldClasses, classes));
	}
	...
	public ObjectProperty getObjectProperties() {
		if (objectProperties != null && objectProperties.eIsProxy()) {
			...
			if (objectProperties != oldObjectProperties) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, mowlPackage.OBJECT_EXACT_CARDINALITY__OBJECT_PROPERTIES, oldObjectProperties, objectProperties));
			}
		}
	...
	public void setObjectProperties(ObjectProperty newObjectProperties) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, mowlPackage.OBJECT_EXACT_CARDINALITY__OBJECT_PROPERTIES, oldObjectProperties, objectProperties));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case mowlPackage.OBJECT_EXACT_CARDINALITY__CARDINALITY:
				return getCardinality();
			case mowlPackage.OBJECT_EXACT_CARDINALITY__CLASSES:
				if (resolve) return getClasses();
				return basicGetClasses();
			case mowlPackage.OBJECT_EXACT_CARDINALITY__OBJECT_PROPERTIES:
