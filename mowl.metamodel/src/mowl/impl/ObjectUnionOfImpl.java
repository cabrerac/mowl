 ...
 * <ul>
 *   <li>{@link mowl.impl.ObjectUnionOfImpl#getClasses <em>Classes</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ObjectUnionOfImpl extends ClassExpressionImpl implements ObjectUnionOf {
	...
	protected EClass eStaticClass() {
		return mowlPackage.Literals.OBJECT_UNION_OF;
	}
	...
	public EList<mowl.Class> getClasses() {
		if (classes == null) {
			classes = new EObjectResolvingEList<mowl.Class>(mowl.Class.class, this, mowlPackage.OBJECT_UNION_OF__CLASSES);
		}
		return classes;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case mowlPackage.OBJECT_UNION_OF__CLASSES:
				return getClasses();
		}
