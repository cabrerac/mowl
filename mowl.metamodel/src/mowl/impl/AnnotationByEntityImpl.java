 ...
 * <ul>
 *   <li>{@link mowl.impl.AnnotationByEntityImpl#getAnnotationValue <em>Annotation Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AnnotationByEntityImpl extends AnnotationImpl implements AnnotationByEntity {
	...
	protected EClass eStaticClass() {
		return mowlPackage.Literals.ANNOTATION_BY_ENTITY;
	}
		...
		if (annotationValue != null && annotationValue.eIsProxy()) {
			...
			if (annotationValue != oldAnnotationValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, mowlPackage.ANNOTATION_BY_ENTITY__ANNOTATION_VALUE, oldAnnotationValue, annotationValue));
			}
		}
	...
	public void setAnnotationValue(Entity newAnnotationValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, mowlPackage.ANNOTATION_BY_ENTITY__ANNOTATION_VALUE, oldAnnotationValue, annotationValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case mowlPackage.ANNOTATION_BY_ENTITY__ANNOTATION_VALUE:
