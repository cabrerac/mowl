 ...
 * <ul>
 *   <li>{@link mowl.impl.DataPropertyAssertionImpl#getDataPropertyExpressions <em>Data Property Expressions</em>}</li>
 *   <li>{@link mowl.impl.DataPropertyAssertionImpl#getTargetValue <em>Target Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataPropertyAssertionImpl extends AssertionImpl implements DataPropertyAssertion {
	...
	protected EClass eStaticClass() {
		return mowlPackage.Literals.DATA_PROPERTY_ASSERTION;
	}
	...
	public NotificationChain basicSetDataPropertyExpressions(DataPropertyExpression newDataPropertyExpressions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, mowlPackage.DATA_PROPERTY_ASSERTION__DATA_PROPERTY_EXPRESSIONS, oldDataPropertyExpressions, newDataPropertyExpressions);
	...
	public void setDataPropertyExpressions(DataPropertyExpression newDataPropertyExpressions) {
		if (newDataPropertyExpressions != dataPropertyExpressions) {
			...
			if (dataPropertyExpressions != null)
				msgs = ((InternalEObject)dataPropertyExpressions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - mowlPackage.DATA_PROPERTY_ASSERTION__DATA_PROPERTY_EXPRESSIONS, null, msgs);
			if (newDataPropertyExpressions != null)
				msgs = ((InternalEObject)newDataPropertyExpressions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - mowlPackage.DATA_PROPERTY_ASSERTION__DATA_PROPERTY_EXPRESSIONS, null, msgs);
			msgs = basicSetDataPropertyExpressions(newDataPropertyExpressions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, mowlPackage.DATA_PROPERTY_ASSERTION__DATA_PROPERTY_EXPRESSIONS, newDataPropertyExpressions, newDataPropertyExpressions));
	}
	...
	public Constant getTargetValue() {
		if (targetValue != null && targetValue.eIsProxy()) {
			...
			if (targetValue != oldTargetValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, mowlPackage.DATA_PROPERTY_ASSERTION__TARGET_VALUE, oldTargetValue, targetValue));
			}
		}
		return targetValue;
	}
	...
	public void setTargetValue(Constant newTargetValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, mowlPackage.DATA_PROPERTY_ASSERTION__TARGET_VALUE, oldTargetValue, targetValue));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case mowlPackage.DATA_PROPERTY_ASSERTION__DATA_PROPERTY_EXPRESSIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case mowlPackage.DATA_PROPERTY_ASSERTION__TARGET_VALUE:
