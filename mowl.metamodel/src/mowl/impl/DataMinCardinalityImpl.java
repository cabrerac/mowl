 ...
 * <ul>
 *   <li>{@link mowl.impl.DataMinCardinalityImpl#getCardinality <em>Cardinality</em>}</li>
 *   <li>{@link mowl.impl.DataMinCardinalityImpl#getDataProperties <em>Data Properties</em>}</li>
 *   <li>{@link mowl.impl.DataMinCardinalityImpl#getLiterals <em>Literals</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataMinCardinalityImpl extends ClassExpressionImpl implements DataMinCardinality {
	...
	protected EClass eStaticClass() {
		return mowlPackage.Literals.DATA_MIN_CARDINALITY;
	}
	...
	public void setCardinality(int newCardinality) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, mowlPackage.DATA_MIN_CARDINALITY__CARDINALITY, oldCardinality, cardinality));
	}
	...
	public DataProperty getDataProperties() {
		if (dataProperties != null && dataProperties.eIsProxy()) {
			...
			if (dataProperties != oldDataProperties) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, mowlPackage.DATA_MIN_CARDINALITY__DATA_PROPERTIES, oldDataProperties, dataProperties));
			}
		}
	...
	public void setDataProperties(DataProperty newDataProperties) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, mowlPackage.DATA_MIN_CARDINALITY__DATA_PROPERTIES, oldDataProperties, dataProperties));
	}
	...
	public EList<Constant> getLiterals() {
		if (literals == null) {
			literals = new EObjectResolvingEList<Constant>(Constant.class, this, mowlPackage.DATA_MIN_CARDINALITY__LITERALS);
		}
		return literals;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case mowlPackage.DATA_MIN_CARDINALITY__DATA_PROPERTIES:
				if (resolve) return getDataProperties();
				return basicGetDataProperties();
			case mowlPackage.DATA_MIN_CARDINALITY__LITERALS:
				return getLiterals();
		}
