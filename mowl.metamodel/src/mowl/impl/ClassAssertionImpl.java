 ...
 * <ul>
 *   <li>{@link mowl.impl.ClassAssertionImpl#getExpressions <em>Expressions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ClassAssertionImpl extends AssertionImpl implements ClassAssertion {
	...
	protected EClass eStaticClass() {
		return mowlPackage.Literals.CLASS_ASSERTION;
	}
	...
	public EList<ClassExpression> getExpressions() {
		if (expressions == null) {
			expressions = new EObjectContainmentEList<ClassExpression>(ClassExpression.class, this, mowlPackage.CLASS_ASSERTION__EXPRESSIONS);
		}
		return expressions;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case mowlPackage.CLASS_ASSERTION__EXPRESSIONS:
