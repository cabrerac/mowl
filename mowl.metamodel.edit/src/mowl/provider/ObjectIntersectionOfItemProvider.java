...
/**
 * This is the item provider adapter for a {@link mowl.ObjectIntersectionOf} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ObjectIntersectionOfItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ObjectIntersectionOf_classes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ObjectIntersectionOf_classes_feature", "_UI_ObjectIntersectionOf_type"),
				 mowlPackage.Literals.OBJECT_INTERSECTION_OF__CLASSES,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		return getString("_UI_ObjectIntersectionOf_type");
	}
