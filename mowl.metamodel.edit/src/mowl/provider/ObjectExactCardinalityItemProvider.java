...
/**
 * This is the item provider adapter for a {@link mowl.ObjectExactCardinality} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ObjectExactCardinalityItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 mowlPackage.Literals.OBJECT_EXACT_CARDINALITY__CARDINALITY,
				 true,
				 false,
				 false,
	...
	protected void addClassesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ObjectExactCardinality_classes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ObjectExactCardinality_classes_feature", "_UI_ObjectExactCardinality_type"),
				 mowlPackage.Literals.OBJECT_EXACT_CARDINALITY__CLASSES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addObjectPropertiesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ObjectExactCardinality_objectProperties_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ObjectExactCardinality_objectProperties_feature", "_UI_ObjectExactCardinality_type"),
				 mowlPackage.Literals.OBJECT_EXACT_CARDINALITY__OBJECT_PROPERTIES,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		ObjectExactCardinality objectExactCardinality = (ObjectExactCardinality)object;
		return getString("_UI_ObjectExactCardinality_type") + " " + objectExactCardinality.getCardinality();
	}
