...
/**
 * This is the item provider adapter for a {@link mowl.ObjectAllValuesFrom} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ObjectAllValuesFromItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ObjectAllValuesFrom_classes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ObjectAllValuesFrom_classes_feature", "_UI_ObjectAllValuesFrom_type"),
				 mowlPackage.Literals.OBJECT_ALL_VALUES_FROM__CLASSES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addObjectPropertiesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ObjectAllValuesFrom_objectProperties_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ObjectAllValuesFrom_objectProperties_feature", "_UI_ObjectAllValuesFrom_type"),
				 mowlPackage.Literals.OBJECT_ALL_VALUES_FROM__OBJECT_PROPERTIES,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		return getString("_UI_ObjectAllValuesFrom_type");
	}
