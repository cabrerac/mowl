...
/**
 * This is the item provider adapter for a {@link mowl.DataAllValuesFrom} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataAllValuesFromItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataAllValuesFrom_dataProperties_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataAllValuesFrom_dataProperties_feature", "_UI_DataAllValuesFrom_type"),
				 mowlPackage.Literals.DATA_ALL_VALUES_FROM__DATA_PROPERTIES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addLiteralsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataAllValuesFrom_literals_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataAllValuesFrom_literals_feature", "_UI_DataAllValuesFrom_type"),
				 mowlPackage.Literals.DATA_ALL_VALUES_FROM__LITERALS,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		return getString("_UI_DataAllValuesFrom_type");
	}
