...
/**
 * This is the item provider adapter for a {@link mowl.DataExactCardinality} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataExactCardinalityItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 mowlPackage.Literals.DATA_EXACT_CARDINALITY__CARDINALITY,
				 true,
				 false,
				 false,
	...
	protected void addDataPropertiesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataExactCardinality_dataProperties_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataExactCardinality_dataProperties_feature", "_UI_DataExactCardinality_type"),
				 mowlPackage.Literals.DATA_EXACT_CARDINALITY__DATA_PROPERTIES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addLiteralsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataExactCardinality_literals_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataExactCardinality_literals_feature", "_UI_DataExactCardinality_type"),
				 mowlPackage.Literals.DATA_EXACT_CARDINALITY__LITERALS,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		DataExactCardinality dataExactCardinality = (DataExactCardinality)object;
		return getString("_UI_DataExactCardinality_type") + " " + dataExactCardinality.getCardinality();
	}
