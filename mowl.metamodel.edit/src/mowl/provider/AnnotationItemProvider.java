...
/**
 * This is the item provider adapter for a {@link mowl.Annotation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AnnotationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 mowlPackage.Literals.ANNOTATION__ANNOTATION_PROPERTY,
				 true,
				 false,
				 false,
	...
	protected void addAnnotationTargetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Annotation_annotationTarget_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Annotation_annotationTarget_feature", "_UI_Annotation_type"),
				 mowlPackage.Literals.ANNOTATION__ANNOTATION_TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		AnnotationProperty labelValue = ((Annotation)object).getAnnotationProperty();
