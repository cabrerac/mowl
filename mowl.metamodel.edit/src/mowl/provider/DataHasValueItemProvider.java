...
/**
 * This is the item provider adapter for a {@link mowl.DataHasValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataHasValueItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataHasValue_dataProperties_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataHasValue_dataProperties_feature", "_UI_DataHasValue_type"),
				 mowlPackage.Literals.DATA_HAS_VALUE__DATA_PROPERTIES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addLiteralsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataHasValue_literals_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataHasValue_literals_feature", "_UI_DataHasValue_type"),
				 mowlPackage.Literals.DATA_HAS_VALUE__LITERALS,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		return getString("_UI_DataHasValue_type");
	}
