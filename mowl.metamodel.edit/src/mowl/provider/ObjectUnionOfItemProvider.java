...
/**
 * This is the item provider adapter for a {@link mowl.ObjectUnionOf} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ObjectUnionOfItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ObjectUnionOf_classes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ObjectUnionOf_classes_feature", "_UI_ObjectUnionOf_type"),
				 mowlPackage.Literals.OBJECT_UNION_OF__CLASSES,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		return getString("_UI_ObjectUnionOf_type");
	}
