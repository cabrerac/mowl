...
/**
 * This is the item provider adapter for a {@link mowl.ObjectComplementOf} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ObjectComplementOfItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ObjectComplementOf_classes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ObjectComplementOf_classes_feature", "_UI_ObjectComplementOf_type"),
				 mowlPackage.Literals.OBJECT_COMPLEMENT_OF__CLASSES,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		return getString("_UI_ObjectComplementOf_type");
	}
