...
/**
 * This is the item provider adapter for a {@link mowl.DataSomeValuesFrom} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataSomeValuesFromItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataSomeValuesFrom_dataProperties_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataSomeValuesFrom_dataProperties_feature", "_UI_DataSomeValuesFrom_type"),
				 mowlPackage.Literals.DATA_SOME_VALUES_FROM__DATA_PROPERTIES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addLiteralsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataSomeValuesFrom_literals_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataSomeValuesFrom_literals_feature", "_UI_DataSomeValuesFrom_type"),
				 mowlPackage.Literals.DATA_SOME_VALUES_FROM__LITERALS,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		return getString("_UI_DataSomeValuesFrom_type");
	}
